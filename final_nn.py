...
def lrcalculation(course):
	...
	model = tf.keras.models.load_model(course+"_RNN.model")
	...
	model1 = tf.keras.models.load_model(course+"_ANN.model")
	...
	model.save(course+'_RNN.model')
	model1.save(course+'_ANN.model')
