...
def lrcalculation(course):
	...
	numpy.random.seed(7)
	# load the dataset
	dataframe = read_csv("C:\\Users\\shwet\\Desktop\\E-learner-Shwetha\\elearner\\elearnerapp\\"+course+"_Data.csv", usecols=[4], engine='python')
	...
	model = tf.keras.models.load_model("C:\\Users\\shwet\\Desktop\\E-learner-Shwetha\\elearner\\elearnerapp\\"+course+"_RNN.h5")
	...
	df = pd.read_csv("C:\\Users\\shwet\\Desktop\\E-learner-Shwetha\\elearner\\elearnerapp\\"+course+'_Data.csv', usecols=[0,1,2,3,5], engine='python')
	...
	model1 = tf.keras.models.load_model("C:\\Users\\shwet\\Desktop\\E-learner-Shwetha\\elearner\\elearnerapp\\"+course+"_ANN.h5")
	...
	model.save("C:\\Users\\shwet\\Desktop\\E-learner-Shwetha\\elearner\\elearnerapp\\"+course+'_RNN.h5')
	model1.save("C:\\Users\\shwet\\Desktop\\E-learner-Shwetha\\elearner\\elearnerapp\\"+course+'_ANN.h5')
